...
class CreateTaskScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: _CreateTaskScreenContent(
...
class _CreateTaskScreenContent extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final createTaskState = Provider.of<CreateTaskState>(context);
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: List.generate(weekDays.length, (index) {
                  final isSelected = index == createTaskState.selectedDayIndex;
                  return GestureDetector(
                    onTap: () => createTaskState.updateSelectedDay(index),
                    child: Container(
                      width: 46,
                      decoration: isSelected
                          ? BoxDecoration(
            ...
            Row(
              children: List.generate(priorities.length, (idx) {
                final selected = idx == createTaskState.selectedPriority;
                return GestureDetector(
                  onTap: () => createTaskState.updatePriority(idx),
                  child: Container(
                    margin: EdgeInsets.only(right: 12),
                    padding: EdgeInsets.symmetric(horizontal: 18, vertical: 10),
                    decoration: BoxDecoration(
            ...
            Row(
              children: [
                ...
                Switch(
                  value: createTaskState.getAlert,
                  onChanged: createTaskState.toggleAlert,
                  activeTrackColor: Color(0xFFC59ADF),
                  activeColor: Color(0xFFDE83B0),
                ),
              ],
              ...
              child: MaterialButton(
                onPressed: () {
                  ...
                  final newTask = Task(
                    ...
                    date:
                        DateTime.now(), // You might want to calculate this based on selected day
                    startTime: "06:00 PM",
                    endTime: "09:00 PM",
                    priority: priorities[createTaskState.selectedPriority],
                    getAlert: createTaskState.getAlert,
                  );

                  // Add task to provider
                  taskProvider.addTask(newTask);

                  // Navigate to edit screen or back to home
                  // Navigator.push(
                  //   context,
                  //   MaterialPageRoute(
                  //     builder: (context) => const EditTaskScreen(),
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => EditTaskScreen(taskId: newTask.id),
                    ),
                  );
                },
                child: Text(
