      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              "You have got 5 tasks\ntoday to complete ✏️",
              style: AppThemes.headlineStyle, // <-- Use centralized style
            ),
          ],
        ),
        actions: [
          Padding(
            ...
            child: CircleAvatar(
              radius: 20,
              backgroundColor: AppThemes.cardBg, // <-- Use centralized color
              child: ClipRRect(
                borderRadius: BorderRadius.circular(20),
                child: Image.asset(
                  'assets/images/person.png',
          ...
          children: [
            ...
            Center(
              child: Icon(
                Icons.add,
                size: 32,
                color: AppThemes.scaffoldBg,
              ), // <-- Use centralized color
            ),
          ],
        ),
      ),
